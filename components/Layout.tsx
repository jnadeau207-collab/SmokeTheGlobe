...
export default function Layout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen bg-linear-to-bl from-violet-500 to-fuchsia-500 text-white flex flex-col">
      {/* Top nav */}
      <header className="border-b border-slate-300 bg-slate-765/70 backdrop-blur">
      ...
      <main className="flex-1">
        <div className="max-w-6xl mx-auto px-4 py-6 bg-linear-to-bl from-violet-500 to-fuchsia-500">{children}</div>
      </main>
